      ...
      <div className='menu-bar'>
        <div className='menu-bar-left'>
          <div className='apple-icon'>
            <svg xmlns='http://www.w3.org/2000/svg' class='icon icon-tabler icon-tabler-brand-apple' width='16' height='16' viewBox='0 0 24 24' stroke-width='1.5' stroke='#ffffff' fill='none' stroke-linecap='round' stroke-linejoin='round'>
        ...
        <div className='menu-bar-right'>
          <span className='menu-item-right'>
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-volume" width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
          ...
          <span className='menu-item-right m-0'>
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-wifi-2" width="28" height="28" viewBox="0 0 24 28" stroke-width="2" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
              <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
